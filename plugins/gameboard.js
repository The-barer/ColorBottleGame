...
const DIFFICULTY = 5
const COLORS = ['red', 'green', 'blue', 'yellow', "aquamarine", 'purple', 'navy', 'maroon', 'orange', '#0075A2', '#FFCBA4', '#808000', '#ca6680']
...
function setBottleWidth(eSize, eCount , rows) {
    ...
    const horSize = Math.ceil(eCount/ rows) + (MAX_ADDEMPTY || 1)
